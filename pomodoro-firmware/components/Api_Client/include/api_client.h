...
/**
 * @brief Inicia las actualizaciones automáticas de tareas
 * @return ESP_OK si se inicia correctamente
 */
esp_err_t api_client_start_auto_refresh(void);

/**
 * @brief Detiene las actualizaciones automáticas
 * @return ESP_OK si se detiene correctamente
 */
esp_err_t api_client_stop_auto_refresh(void);

/**
 * @brief Obtiene las tareas manualmente (sin esperar al timer)
